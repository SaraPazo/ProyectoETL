...
CREATE SCHEMA IF NOT EXISTS `entradas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `entradas` ;

-- -----------------------------------------------------
-- Table `entradas`.`eventos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `entradas`.`eventos` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `entradas`.`no_residentes` (
  ...
  CONSTRAINT `eventos_id`
    ...
    REFERENCES `entradas`.`eventos` (`eventos_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `entradas`.`residentes` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `entradas`.`asistencia` 
	(`comunidad` INT NULL DEFAULT NULL,
  ...
  CONSTRAINT `residentes_id`
    ...
    REFERENCES `entradas`.`residentes` (`residentes_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `no_residentes_id`
    FOREIGN KEY (`no_residentes_id`)
    REFERENCES `entradas`.`no_residentes` (`no_residentes_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
